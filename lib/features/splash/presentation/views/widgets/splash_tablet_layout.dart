...
class SplashTabletLayout extends StatelessWidget {
  const SplashTabletLayout({super.key});

  @override
  Widget build(BuildContext context) {
    return const SafeArea(
      child: Center(child: SizedBox(width: 560, child: _TabletSplashContent())),
    );
  }
}

class _TabletSplashContent extends StatelessWidget {
  const _TabletSplashContent();
